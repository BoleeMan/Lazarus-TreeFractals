...
begin
  ...
  begin
    ...
    drawTree(x2, y2, angle - 27 , depth - 4);
    drawTree(x2, y2, angle + 27 , depth - 4);
 ...
 begin
    Bitmap.GradientFill(0, 0, Bitmap.Width, Bitmap.Height, clSkyBlue, BGRA(100,175,10), gtLinear, PointF(0,0), PointF(0, Bitmap.Height), dmSet);
   drawTree(Bitmap.Width div 2, Bitmap.Height, -91, 32);
end;
